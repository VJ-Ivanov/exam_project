...
from app.views import LandingPage, OfferListView, MasterData, CustomerListView, TruckerListView, \
    CustomerCreateView, CustomerDeleteView, CustomerUpdateView, details_or_add_warehouse
...
urlpatterns = (
    ...
    path('master_data/customers/details/<int:pk>', details_or_add_warehouse, name='customer details'),
